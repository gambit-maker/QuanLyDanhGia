    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p>Page</p>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="login.php?TenChucVu=<?php echo $tenChucVu; ?>">
                ...
                <?php if ($tenChucVu === 'admin' || $tenChucVu === 'nhanvien') : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=calculate">
                            <span data-feather="shopping-cart"></span>
                            Xem thống kê
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=thongkenangcao">
                            <span data-feather="shopping-cart"></span>
                            Thống kê nâng cao
                        </a>
                    </li>
                ...
                <?php if ($tenChucVu == 'giaovien' || $tenChucVu === 'truongbomon' || $tenChucVu === 'truongkhoa') : ?>
                    <li class="nav-item">
                        <a class="nav-link" href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=ratingInfo">
            ...
            <?php if ($tenChucVu === 'admin') : ?>
                <ul class="list-unstyled components">
                    <p>Database</p>
                    <li class="nav-item">
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBlopHocPhan" class=" nav-link">Danh sách các lớp học phần</a>
                    </li>
                    <li class="nav-item">
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBMonHoc" class=" nav-link">Danh sách môn học</a>
                    </li>
                    <li>
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBNamHoc" class=" nav-link">Danh Sách năm học</a>
                    </li>
                    <li class="nav-item">
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBGiaoVien" class=" nav-link">Danh sách giáo viên</a>
                    </li>
                    <li class="nav-item">
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBChucVu" class=" nav-link">Danh sách chức vụ</a>
                    </li>
                    <li class="nav-item">
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBKhoa" class=" nav-link">Danh sách khoa</a>
                    </li>
                    <li class="nav-item">
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBBoMon" class=" nav-link">Danh sách bộ môn</a>
                    </li>

                    <li class="nav-item">
                        <a href="login.php?TenChucVu=<?php echo $tenChucVu; ?>&page=DBNhanVien" class=" nav-link">Danh sách nhân viên</a>
                    </li>
            ...
            <ul class="list-unstyled CTAs">
                <li>
                    <a href="index.php" class="download">Sign out </a>
                </li>
                <!-- <li>
                    <a href="index.php" class="article">Sign out</a>
                </li> -->
            </ul>
        </nav>
